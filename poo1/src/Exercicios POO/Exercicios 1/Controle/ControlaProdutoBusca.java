package controle;
import dominio.Produto1;
import java.util.ArrayList;
import java.util.Scanner;
public class ControlaProdutoBusca {
   // Método estático para busca por código na coleção
   public static Produto1 buscarPorCodigo(ArrayList<Produto1> lista, String codigo) {
   ...
   public static void aplicarReajusteGeral(ArrayList<Produto1> lista, double percentual) {
       for (Produto1 p : lista) {
   ...
   public static void main(String[] args) {
       ...
       listaProdutos.add(new Produto1("P01", "Teclado", 150.00));
       listaProdutos.add(new Produto1("P02", "Mouse", 80.00));
       listaProdutos.add(new Produto1("P03", "Monitor", 750.00));
       do {
           System.out.println("\n========================================");
           ...
           switch (opcao) {
               case 1:
                   ...
                   scanner.nextLine();
                   listaProdutos.add(new Produto1(cod, nome, preco));
               ...
               case 3:
                   ...
                   Produto1 prodEncontrado = buscarPorCodigo(listaProdutos, codigoBusca);
